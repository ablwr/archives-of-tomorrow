...
const Header = () => (
  <div id="header">
    ...
    <nav className="border-b-2 border-orange-600 grid grid-cols-2 pt-2">
      <Link to="/about/" className="max-w-xs h-20">
      ...
      <Link to="/books/" className="max-w-xs h-20 justify-self-end">
        <svg viewBox="0 0 200 200" className="fill-orange-400">
          <path
        ...
        <span className="pr-12 pb-16 text-xl font-bold hover:text-orange-800">
          Books
        </span>
      </Link>
    </nav>
