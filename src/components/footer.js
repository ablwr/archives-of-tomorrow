...
const Footer = () => (
  <div id="footer">
    <nav className="border-t-2 border-orange-600 grid grid-cols-2 pt-2">
      <Link to="/illustrations/" className="max-w-xs h-20">
        ...
        <span className="pt-4 text-xl font-bold hover:text-orange-900">
          Illustrations
        </span>
      </Link>
      <Link to="/data/" className="max-w-xs h-20 justify-self-end">
        <svg viewBox="0 0 200 200" className="fill-orange-400">
          <path
        ...
        <span className="pr-12 pt-2 text-xl font-bold hover:text-orange-900">
          Data
        </span>
      </Link>
    </nav>
